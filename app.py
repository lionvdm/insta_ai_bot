...
- Если клиент перешел на английский — всё твое сообщение должно быть на английском.
- Если на казахский — только на казахском.
...
**Формат:** Коротко, драйвово, каждое сообщение заканчивается вопросом. Твой язык = языку последнего сообщения клиента.
"""
...
def ask_gpt(user_id, user_message):
    try:
        ...
        messages_to_send.append({
            "role": "system", 
            "content": (
                "CRITICAL: Look at the LAST message. If it is in English, you MUST respond in English. "
                "Если на русском — отвечай по-русски. Егер соңғы хабарлама қазақша болса — ТЕК ҚАЗАҚША жауап бер. "
                "Don't be lazy. Change your language NOW based on the last user message. "
                "STRICT B2C SALES MODE ON."
            )
        })
